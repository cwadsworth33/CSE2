...
public class FourDwin{
    public static void main(String [] args){
        ...
        int [][] dimensions = randomizeDimension(x,y); //create dimensions array 
        double [][][]SubArray1=randomMatrix(dimensions[0][0],dimensions[0][1],dimensions[0][2]); //create subarrays
        ...
        double[][][][] jaggedArray = new double[3][][][]; //initialize 4D array
        jaggedArray[0]=SubArray1; //assign subarrays to 4D array
        jaggedArray[1]=SubArray2;
        jaggedArray[2]=SubArray3; 
        print4DMatrix(jaggedArray);//Print unsorted array
        print2DMatrix(dimensions);//print dimensions of matrix
        statArray(jaggedArray,dimensions); //find statistics of array
        sort4DArray(dimensions,jaggedArray); //sort array by 3D arrays
        print4DMatrix(jaggedArray);//print sorted array
        ///////////////////////////////////////////////////////
